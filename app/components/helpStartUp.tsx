  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      ...
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-center">
        <span className="text-[#1C1C1C]">We help startups</span>{" "}
        <span className="text-[#828282] ">and enterprises grow with</span>{" "}
        <span className="text-[#A7A7A7] ">fast,</span>{" "}
        <span className="text-[#DFDFDF] ">creative, and scalable technology.</span>
      ...
      <ul className="mt-6 space-y-4">
        {services.map((service) => (
          ...
          >
            ...
            {/* Hover Content - Also shows on click for mobile */}
            {(activeService === service.name) && (
              <div className="flex flex-col md:flex-row gap-4 md:gap-6 mt-2">
                ...
                <div className="md:w-1/3 h-32 rounded-lg overflow-hidden order-first md:order-none">
                  <img
                    ...
                    alt={service.name}
                    className="w-full h-full object-cover rounded-[400] border-2 border-gray-300"
                  />
                </div>

                {/* Tags with rounded borders */}
